  ...
  render() {
    ...
    const content = (
      <div className={styles.pageHeaderContent}>
        <p>写最少的代码</p>
        <div className={styles.contentLink}></div>
      </div>
    );
    const extraContent = (
                      ...
                      <Card.Meta
                        ...
                        avatar={
                          <img
                            ...
                            src="http://5b0988e595225.cdn.sohucs.com/images/20171109/24e53a18df974391a39e5ded44ef8952.jpeg"
                          />
                        }
                        title={<a>{item.name}</a>}
                        description={
